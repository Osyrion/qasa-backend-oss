...
return new class extends Migration
{
     ...
     * widened the column to string() via ->change() only alters the column
     * type, leaving the old "exchange_rates_source_check" constraint
     * (manual|ecb|fixer) in place — rejecting the newer 'cnb' value enforced
     * by the ExchangeRateSource enum.
     */

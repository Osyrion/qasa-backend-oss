...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'status', type: 'string', enum: ['draft', 'active', 'completed', 'archived']),
        new OA\Property(property: 'billing_type', type: 'string', nullable: true, enum: ['fixed_price', 'hourly_rate', 'retainer']),
        ...
        new OA\Property(property: 'time_entries_count', type: 'integer', nullable: true),
        new OA\Property(property: 'uninvoiced_entries_count', type: 'integer', nullable: true),
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'time_entries_count' => $this->when(
                isset($this->time_entries_count),
                fn (): int => (int) $this->resource->time_entries_count,
            ),

            'uninvoiced_entries_count' => $this->when(
                isset($this->uninvoiced_entries_count),
                fn (): int => (int) $this->resource->uninvoiced_entries_count,
            ),

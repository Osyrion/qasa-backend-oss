...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'overdue_digest_enabled', type: 'boolean', example: true, description: 'Whether the owner receives a daily digest e-mail of invoices newly past due'),
        ...
        new OA\Property(property: 'role', type: 'string', example: 'owner', nullable: true),
...
class UserResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'overdue_digest_enabled' => $this->resource->overdue_digest_enabled,
            ...
            // Only present when the account exposes a plan
            'plan' => $this->when(

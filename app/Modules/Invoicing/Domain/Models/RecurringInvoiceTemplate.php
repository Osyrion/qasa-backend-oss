 ...
 * @method static Builder<static>|RecurringInvoiceTemplate whereAutoSend($value)
 * @method static Builder<static>|RecurringInvoiceTemplate whereClientId($value)
 * @method static Builder<static>|RecurringInvoiceTemplate whereCreatedAt($value)
 * @method static Builder<static>|RecurringInvoiceTemplate whereCurrency($value)
 * @method static Builder<static>|RecurringInvoiceTemplate whereDayOfMonth($value)
 * @method static Builder<static>|RecurringInvoiceTemplate whereDeletedAt($value)
 * @method static Builder<static>|RecurringInvoiceTemplate whereDiscountPercent($value)
 * @method static Builder<static>|RecurringInvoiceTemplate whereDueDays($value)
 * @method static Builder<static>|RecurringInvoiceTemplate whereEndDate($value)
 * @method static Builder<static>|RecurringInvoiceTemplate whereFirstIssueDate($value)
 * @method static Builder<static>|RecurringInvoiceTemplate whereId($value)
 * @method static Builder<static>|RecurringInvoiceTemplate whereLastDayOfMonth($value)
 * @method static Builder<static>|RecurringInvoiceTemplate whereLastGeneratedAt($value)
 * @method static Builder<static>|RecurringInvoiceTemplate whereName($value)
 * @method static Builder<static>|RecurringInvoiceTemplate whereNextRunDate($value)
 * @method static Builder<static>|RecurringInvoiceTemplate whereNoteAbove($value)
 * @method static Builder<static>|RecurringInvoiceTemplate whereNoteBelow($value)
 * @method static Builder<static>|RecurringInvoiceTemplate wherePeriod($value)
 * @method static Builder<static>|RecurringInvoiceTemplate whereReverseCharge($value)
 * @method static Builder<static>|RecurringInvoiceTemplate whereStatus($value)
 * @method static Builder<static>|RecurringInvoiceTemplate whereTaxDateMode($value)
 * @method static Builder<static>|RecurringInvoiceTemplate whereType($value)
 * @method static Builder<static>|RecurringInvoiceTemplate whereUpdatedAt($value)
 * @method static Builder<static>|RecurringInvoiceTemplate whereUserId($value)
 *
 * @mixin Eloquent
 */

...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'vendor_account_number', type: 'string', nullable: true, description: 'Domestic format [prefix-]number'),
        new OA\Property(property: 'vendor_bank_code', type: 'string', nullable: true),
        new OA\Property(property: 'vendor_iban', type: 'string', nullable: true),
        new OA\Property(property: 'vendor_bic', type: 'string', nullable: true),
        new OA\Property(property: 'account_source', type: 'string', nullable: true, enum: ['manual', 'ocr']),
        new OA\Property(property: 'account_verified_at', type: 'string', format: 'date-time', nullable: true),
        new OA\Property(property: 'account_verification_result', type: 'string', nullable: true, enum: ['published', 'unpublished', 'unreliable']),
        new OA\Property(property: 'handed_to_payment_at', type: 'string', format: 'date-time', nullable: true),
...
class SupplierInvoiceResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'vendor_account_number' => $this->resource->vendor_account_number,
            'vendor_bank_code' => $this->resource->vendor_bank_code,
            'vendor_iban' => $this->resource->vendor_iban,
            'vendor_bic' => $this->resource->vendor_bic,
            'account_source' => $this->resource->account_source,
            'account_verified_at' => $this->resource->account_verified_at?->toISOString(),
            'account_verification_result' => $this->resource->account_verification_result,
            'handed_to_payment_at' => $this->resource->handed_to_payment_at?->toISOString(),

...
return [
    ...
    | Other values are reserved for edition overlays that replace the
    | authorization layer.
    |
    */
    ...
    'features' => [
        ...
        // Public registration endpoint; off by default — users are created
        // via the `qasa:user` artisan command instead.

...
return [
    ...
    'settle_only_proforma' => 'Only a proforma invoice can be settled.',
    'settle_requires_paid_proforma' => 'A proforma can only be settled once it is fully paid.',
    'proforma_already_settled' => 'This proforma has already been settled.',
    'settled_from_proforma' => 'Paid via proforma :number',
    ...
    'payment_order_sepa_eur_only' => 'SEPA (pain.001) export requires a EUR batch.',
    'payment_order_sepa_payer_iban_missing' => 'SEPA export requires an IBAN on the payer bank account.',
    'payment_order_sepa_item_iban_missing' => 'Vendor :vendor has no IBAN and no convertible domestic account for SEPA export.',
